...
export default function PaymentCallback() {
  ...
  const returnTutorId = sessionStorage.getItem("booking_return_tutor_id");

  const handleContinue = () => {
    sessionStorage.removeItem("booking_return_tutor_id");
    if (returnTutorId) {
      navigate(`/tutors/${returnTutorId}`);
    } else {
          ...
          {status === "success" && (
            <>
              ...
              <p className="text-slate-500 mb-6">
                Your payment was successful and your session has been booked. The tutor will be notified.
              </p>
